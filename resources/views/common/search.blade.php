            ...
            <div class="form-group row">
                <div class="input-group col-3">
                    ...
                    <select class="custom-select" id="user_id">
                        ...
                        @foreach(\App\User::select(\DB::raw('count(record.user_id) as count'), \DB::raw('users.*'))->join('record', 'users.id', '=', 'record.user_id')->groupBy('users.id')->orderBy('count', 'DESC')->get() as $user)
